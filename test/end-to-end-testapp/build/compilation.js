var upolloKit = (function (exports) {
    'use strict';
    ...
    */
    ...
    function upTrack(mParticleUser, eventType, upClient) {
      console.log("track", mParticleUser);
    ...
    IdentityHandler.prototype.onIdentifyComplete = function (
      ...
      console.log("onIdentifyComplete", this.common);
    ...
    IdentityHandler.prototype.onLoginComplete = function (
      ...
      console.log("onLoginComplete", this.common);
    ...
    IdentityHandler.prototype.onModifyComplete = function (
      ...
      console.log("onModify", mParticleUser);
    };
    ...
    */
    ...
    console.log("pre init upollo-mparticle");
    ...
    */
      initForwarder: function (
        ...
        console.log("init upollo-mparticle", common);
        common.__proto__.value1 = "1";
        ...
        if (!testMode) {
          ...
          console.warn("testing without upollo client");
    ...
    */
    ...
    UserAttributeHandler.prototype.onSetUserAttribute = function (
      ...
      console.log("onSetUserAttribute");
    };
    ...
    var SDKsettings = {
      ...
      apiKey:
        "Ch9XrnhZAcANxMJv4v7QoKmx6T23ovK4W9BB7D2DgHFC1dad41d209a045760d7a44a45190d47dcd1b304fb51938d738e00b32d052ea6c",
